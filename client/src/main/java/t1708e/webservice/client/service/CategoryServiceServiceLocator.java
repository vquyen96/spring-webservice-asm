...
public class CategoryServiceServiceLocator extends org.apache.axis.client.Service implements t1708e.webservice.client.service.CategoryServiceService {
    ...
    public t1708e.webservice.client.service.CategoryService getCategoryServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public t1708e.webservice.client.service.CategoryService getCategoryServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            t1708e.webservice.client.service.CategoryServicePortBindingStub _stub = new t1708e.webservice.client.service.CategoryServicePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (t1708e.webservice.client.service.CategoryService.class.isAssignableFrom(serviceEndpointInterface)) {
                t1708e.webservice.client.service.CategoryServicePortBindingStub _stub = new t1708e.webservice.client.service.CategoryServicePortBindingStub(new java.net.URL(CategoryServicePort_address), this);
                _stub.setPortName(getCategoryServicePortWSDDServiceName());
                return _stub;
            }
        }
