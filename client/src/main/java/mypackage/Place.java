...
public class Place  implements java.io.Serializable {
    private mypackage.Category category;
    ...
    private mypackage.PlaceImage[] placeImages;
    ...
    public Place(
           ...
           mypackage.PlaceImage[] placeImages,
     ...
     * @return category
     */
    public mypackage.Category getCategory() {
        return category;
    }
     ...
     * @param category
     */
    public void setCategory(mypackage.Category category) {
        this.category = category;
    }
     ...
     * @return placeImages
     */
    public mypackage.PlaceImage[] getPlaceImages() {
        return placeImages;
    }
     ...
     * @param placeImages
     */
    public void setPlaceImages(mypackage.PlaceImage[] placeImages) {
        this.placeImages = placeImages;
    }

    public mypackage.PlaceImage getPlaceImages(int i) {
        return this.placeImages[i];
    }

    public void setPlaceImages(int i, mypackage.PlaceImage _value) {
